...
void mkImage::create(uint32 width,
  uint32 height,
  uint16 bitsPerPixel)
{
  m_width = width;
...
void mkImage::encode(const String& filePath)
{
...
Color mkImage::getPixel(uint32 x, uint32 y) const
{
...
void mkImage::setPixel(uint32 x, uint32 y, const Color& color)
{
...
void mkImage::clearColor(const Color& color)
{
...
void mkImage::decode(const String& filePath)
{
